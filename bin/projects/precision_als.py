...
def export_data(datadir: Path) -> DataFrame:
	...
	urg_diagnoses = load_hub_episode_diagnoses(datadir, 'hub_urg/diagnoses', urg_episodes)
	hosp_diagnoses = load_hub_episode_diagnoses(datadir, 'hub_hosp/diagnoses', hosp_episodes)
